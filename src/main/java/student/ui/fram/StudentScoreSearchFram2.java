...
public class StudentScoreSearchFram2 extends JFrame {

	private JPanel contentPane;

	public StudentScoreSearchFram2() {
		initialize();
	}
	private void initialize() {
		...
		StdMgnSearchpanel panel = new StdMgnSearchpanel();
		pTop.add(panel, BorderLayout.SOUTH);
